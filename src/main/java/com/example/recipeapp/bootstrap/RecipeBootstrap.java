...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addIngredient(new Ingredient("Kosher salt", new BigDecimal(".5"), "tsp"));
        guacRecipe.addIngredient(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), "tbsp"));
        ...
        tacosRecipe.addIngredient(new Ingredient("Ancho Chili Powder", new BigDecimal(2), "tbsp"));
        tacosRecipe.addIngredient(new Ingredient("Dried Oregano", new BigDecimal(1), "tsp"));
        tacosRecipe.addIngredient(new Ingredient("Dried Cumin", new BigDecimal(1), "tsp"));
        tacosRecipe.addIngredient(new Ingredient("Sugar", new BigDecimal(1), "tsp"));
        tacosRecipe.addIngredient(new Ingredient("Salt", new BigDecimal(".5"), "tsp"));
        tacosRecipe.addIngredient(new Ingredient("Clove of Garlic, Choppedr", new BigDecimal(1), "each"));
        tacosRecipe.addIngredient(new Ingredient("finely grated orange zestr", new BigDecimal(1), "tbsp"));
        tacosRecipe.addIngredient(new Ingredient("fresh-squeezed orange juice", new BigDecimal(3), "tbsp"));
        tacosRecipe.addIngredient(new Ingredient("Olive Oil", new BigDecimal(2), "tbsp"));
        tacosRecipe.addIngredient(new Ingredient("boneless chicken thighs", new BigDecimal(4), "tbsp"));
